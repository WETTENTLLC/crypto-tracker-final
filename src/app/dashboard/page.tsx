...
import CryptoHealthIndicator from '../components/CryptoHealthIndicator';
    ...
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        const [
          ...
          productionDataService.getCryptocurrencyData(),
          productionDataService.getUserAlerts(),
          productionDataService.getPortfolioData(),
          productionDataService.getRecentActivity(),
          productionDataService.getTrendingCoins()
        ]);

        setWatchlist(watchlistData);
        setAlerts(alertsData);
        setPortfolioValue({
          total: portfolioDataResponse.total,
          change: portfolioDataResponse.change,
          changePercent: portfolioDataResponse.changePercent,
          isPositive: portfolioDataResponse.isPositive
        });
        setPortfolioData(portfolioDataResponse.holdings.map((h: any) => ({ name: h.name, value: h.value })));
        ...
        <>
          <div className="md:flex md:items-center md:justify-between mb-8">
            <div className="flex-1 min-w-0">
              <p className="text-gray-600">Welcome back! Here's an overview of your cryptocurrency portfolio and alerts.</p>
            </div>
            <div className="mt-4 flex items-center space-x-4 md:mt-0 md:ml-4">
              <CryptoHealthIndicator className="hidden sm:flex" />
              {!isPremium && (
                <Link
                  href="/premium"
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <Link href={`/coin/${coin.id}`} className="flex items-center">
                              ...
                              <div className="ml-4">
                                ...
                                <div className="text-sm text-black">{coin.symbol}</div>
                              </div>
                            </Link>
                          </td>
              ...
              <div className="border-t border-gray-200">
                {alerts.length > 0 ? (
                  ...
                  <div className="p-6 text-center">
                    <p className="text-black">You haven&apos;t set any price alerts yet.</p>
                    <Link 
                      href="/" 
          ...
          <div className="mb-8">
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="px-4 py-5 sm:px-6 flex justify-between items-center">
                <div>
                  <h2 className="text-lg leading-6 font-medium text-gray-900">Data Sources Health</h2>
                  <p className="mt-1 text-sm text-gray-600">
                    Monitor the health and reliability of cryptocurrency data sources
                  </p>
                </div>
                <button
